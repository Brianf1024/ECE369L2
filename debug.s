...
#
#
#$t0 is a character in the string
#$t1 is the index of the string starting at zero and going to the size of the string
#$t2 is the count of the determined character found in the string
#$t3 is character we want to find
...
main:	
	...
	li      $t1, 0          # initialize register $t1 to '0' I think this holds the index of the character
	li      $t2, 0          # initialize register $t2 to '0' I think this holds the count
